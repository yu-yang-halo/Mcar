...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2,AlipayInfo alipayInfo) {
		Map<String, String> keyValues = new HashMap<String, String>();

		keyValues.put("app_id", app_id);

		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""
				+alipayInfo.getPrice()+"\",\"subject\":\""
				+alipayInfo.getSubject()+"\",\"body\":\""
				+alipayInfo.getBody()+"\",\"out_trade_no\":\""
		...
		String timestamp=TimeUtils.currentTime();
